...
const numberphone = faker.number.int();
let firstLetter_lastname = lastname.charAt(0)
const user_full_name = firstname +" "+firstLetter_lastname
...
describe('My account', () => {
   ...
   /* it('access to My account && verify user settings', () => {
    ...
    it(' modify firstname/lastname/email/number && save && verify the new user details', () => {
        cy.get('[href="/user/settings"]').contains('My Account').click()
        ...
        cy.get('[data-test="user-settings-phoneNumber-input"]').clear().type(numberphone)
